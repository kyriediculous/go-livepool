...
func main() {
	...
	orchAddr := flag.String("orchAddr", "104.45.20.161:8935", "Orchestrator to connect to as a standalone transcoder")
	...
	orchSecret := flag.String("orchSecret", "livepool", "Shared secret with the orchestrator as a standalone transcoder")
